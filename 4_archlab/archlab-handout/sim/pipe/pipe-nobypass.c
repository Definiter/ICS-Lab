...
int gen_F_stall()
{
    return (((((id_ex_next->srca) != (REG_NONE)) & ((id_ex_next->srca) == 
            ...
            (id_ex_curr->deste) || (id_ex_next->srca) == 
    ...
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | ((!(((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (I_RET) == (ex_mem_curr->icode))) & !((((id_ex_next->srca) != 
              (REG_NONE)) & ((id_ex_next->srca) == (id_ex_curr->destm) || 
              (id_ex_next->srca) == (id_ex_curr->deste) || 
